    ...
    <nav className="fixed-top bg-white shadow-sm px-5 py-2 d-flex align-items-center justify-content-between">
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          <Link to="roomPage/01" className="mx-2 text-decoration-none">
            Viet Duc
          </Link>
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="dropdown dropstart">
          ...
          <ul className="dropdown-menu mt-2">
            ...
            <li>
              <a className="dropdown-item py-2 my-2" href="">
                <i className="fa-solid fa-clock-rotate-left mr-2"></i> Đặt phòng
                của tôi
              </a>
            </li>
            <li>
              <a className="dropdown-item py-2 my-2" href="">
                <i className="fa-regular fa-heart mr-2"></i>Danh sách yêu thích
              </a>
            </li>
